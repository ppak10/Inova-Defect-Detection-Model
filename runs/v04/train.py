"""
Entry point: uv run python -m runs.v04.train
...
inova-defect-v04; checkpoints in runs/v04/checkpoints/.

Smoke test:
    uv run python -m runs.v04.train --max-cases 8 --epochs 1 --no-wandb
"""
...
def main() -> None:
    ...
    if not args.no_wandb:
        ...
        run = wandb.init(project="inova-defect-v04", config=vars(args))
